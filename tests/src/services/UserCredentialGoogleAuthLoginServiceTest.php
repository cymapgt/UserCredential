 ...
 */
class UserCredentialGoogleAuthLoginServiceTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testAuthenticateStage2() {
         ...
         *          when using Google Authenticator because of 30 second limit
         * 
    ...
    public function testAuthenticateStage2UsernameNotSetException() {
        ...
        $this->setExpectedException('cymapgt\Exception\UserCredentialException', 'Cannot validate a TOTP token when username is not set');
    ...
    public function testAuthenticateStage2TokenNotCreatedException() {
        ...
        $this->setExpectedException('cymapgt\Exception\UserCredentialException', 'The TOTP token for the current user does not exist');
